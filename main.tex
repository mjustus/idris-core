...
\inferrule*[Right=Case]{
  ...
  \left( \definition{dc}_i \OF {\Phi_i \to {\AppTele {\TyCon {tc}} {\delta_i}}} \right) \in \Sigma\\\\
  \checkJ \Sigma \Gamma e {p q} {\AppTele {\TyCon {tc}} {\delta}} \\\\
%  \checkJ \Sigma {\Delta, (\name x \OFq q {\AppTele {\TyCon {tc}} {q_i} {{\name y}_i}})} A \zero \Type \\\\
  \checkJ \Sigma {\restrictQ \Gamma p, \multQ {\Phi_i} q} {e_i} {\presence p} {?}\\\\
  \presence p = \one \land q = \zero \implies i \leq 1
} {
  \checkJ \Sigma \Gamma
    {\Case e
      q
      {\AppTele {\TyCon {tc}} {\delta}}
      {\Clause {{\definition {dc}}_i~ \Phi_i} {e_i}}
    }
    q
    {?}
}
